...
public abstract class DOMDigestMethod extends DOMStructure
  ...
  static final String GOST3411 = "http://www.w3.org/2001/04/xmldsig-more#gostr3411";
  static final String GOST3411URN = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr3411";
  ...
  static DigestMethod unmarshal(Element dmElem) throws MarshalException {
    ...
    } else if (alg.equals(GOST3411)) {
      return new GOST3411(dmElem);
    } else if (alg.equals(GOST3411URN)) {
   ...
   * @param prefix namespace prefix to use
  ...
  static final class GOST3411 extends DOMDigestMethod {
    GOST3411(AlgorithmParameterSpec params) throws InvalidAlgorithmParameterException {
      super(params);
    }
  ...
  static final class GOST3411URN extends DOMDigestMethod {
    GOST3411URN(AlgorithmParameterSpec params) throws InvalidAlgorithmParameterException {
      super(params);
    }
