...
public final class DOMXMLSignatureFactory extends XMLSignatureFactory {
  ...
  public DigestMethod newDigestMethod(String algorithm,
    ...
    } else if (algorithm.equals(DOMDigestMethod.GOST3411))
      return new DOMDigestMethod.GOST3411(params);
    else if (algorithm.equals(DOMDigestMethod.GOST3411URN)) {
  ...
  public SignatureMethod newSignatureMethod(String algorithm,
    ...
    } else if (algorithm.equals(DOMSignatureMethod.GOSTR34102001_GOSTR3411URN)) {
