...
public enum ТипДокумента {
  ...
  UNKNOWN("Не определен тип документа", null), 
  СТРАХОВОЕ_СВИДЕТЕЛЬСТВО_ОБЯЗАТЕЛЬНОГО_ПЕНСИОННОГО_СТРАХОВАНИЯ("267"),
  СТРАХОВОЕ_СВИДЕТЕЛЬСТВО_ГОСУДАРСТВЕННОГО_ПЕНСИОННОГО_СТРАХОВАНИЯ("112"),
  СВИДЕТЕЛЬСТВО_О_ПОСТАНОВКЕ_НА_УЧЁТ_ФИЗИЧЕСКОГО_ЛИЦА_В_НАЛОГОВОМ_ОРГАНЕ("319"),
  ПАСПОРТ_ГРАЖДАНИНА_РФ("Паспорт гражданина РФ", null, "50"), 
  СВИДЕТЕЛЬСТВО_О_РОЖДЕНИИ("418"), 
  ВОЕННЫЙ_БИЛЕТ("7"), 
  СВИДЕТЕЛЬСТВО_О_БРАКЕ("81"), 
  КВИТАНЦИЯ_ОБ_ОПЛАТЕ("458"),
  // FNS 3777
  ...
  ВЫПИСКА_ИЗ_ЕГРП_НА_НЕДВИЖИМОЕ_ИМУЩЕСТВО_И_СДЕЛОК_С_НИМ_О_ПРАВАХ_ОТДЕЛЬНОГО_ЛИЦА_НА_ИМЕЮЩИЕСЯ_У_НЕГО_ОБЪЕКТЫ_НЕДВИЖИМОСТИ("Выписка из ЕГРП на недвижимое имущество и сделок с ним о правах отдельного лица на имеющиеся у него объекты недвижимости", "rr3564", "366"),
  ...
  КАДАСТРОВЫЙ_ПАСПОРТ_ОБЪЕКТА_НЕДВИЖИМОСТИ(null, "rr3564", "39"),
  КАДАСТРОВАЯ_ВЫПИСКИ_ОБ_ОБЪЕКТЕ_НЕДВИЖИМОСТИ(null, "rr3564"),
  КАДАСТРОВЫЙ_ПЛАН_ТЕРРИТОРИИ(null, "rr3564", "270"),
  ...
  ВЫПИСКА_ИЗ_ЕГРИП_ПОЛНАЯ("Выписка из ЕГРИП полная", "fns3554", "209"),
  // PFRF 3622
  ...
  // MCOMM 1019 
  СВЕДЕНИЯ_О_НЕПОЛУЧЕНИИ_ЕЖЕМЕСЯЧНОГО_ПОСОБИЯ_ПО_УХОДУ_ЗА_РЕБЕНКОМ_В_ОРГАНАХ_СОЦИАЛЬНОЙ_ЗАЩИТЫ_НАСЕЛЕНИЯ("Сведения о неполучении ежемесячного пособия по уходу за ребенком в органах социальной защиты населения", "mcomm1019", "315"),
  // FSSP 3924
