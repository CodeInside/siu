...
public class DOCUMENT {
  ...
  public String toString() {
    return "DOCUMENT [name=" + name + ", seriesRomanNumerals=" + seriesRomanNumerals + ", seriesRussianSymbols=" + seriesRussianSymbols
        + ", number=" + number + ", issueDate=" + issueDate + ", issueAgency=" + issueAgency + "]";
  }
