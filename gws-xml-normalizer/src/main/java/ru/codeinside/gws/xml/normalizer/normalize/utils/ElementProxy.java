...
import ru.codeinside.gws.xml.normalizer.normalize.exceptions.Base64DecodingException;
...
public abstract class ElementProxy {
    ...
    protected final static Logger log = Logger.getLogger(ElementProxy.class.getName());
    ...
    public ElementProxy(Element element, String BaseURI) throws XMLSecurityException {
        ...
        log.fine("setElement(\"" + element.getTagName() + "\", \"" + BaseURI + "\")");
     ...
     * @throws ru.codeinside.gws.xml.normalizer.normalize.exceptions.Base64DecodingException
     */
    ...
    public static void setDefaultPrefix(String namespace, String prefix)
        ...
        if (Constants.EncryptionSpecNS.equals(namespace)) {
