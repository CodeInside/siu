package net.mobidom.oep.fns3521;
...
public class FNS3521Client implements Client {

	static Logger log = Logger.getLogger(FNS3521Client.class.getName());
	...
	public URL getWsdlUrl() {
		// TODO
		return getClass().getClassLoader().getResource("fns3521/?????.wsdl");
	}
