package net.mobidom.oep.mvd3879;
...
public class MVD3879Client implements Client {

	static Logger log = Logger.getLogger(MVD3879Client.class.getName());
	...
	public URL getWsdlUrl() {
		// TODO
		return getClass().getClassLoader().getResource("mvd3879/?????.wsdl");
	}
