    ...
    public void check(Database database, DatabaseChangeLog changeLog, ChangeSet changeSet) throws PreconditionFailedException, PreconditionErrorException {
        ...
        try {
            ...
            if (this.getOnFail().equals(PreconditionContainer.FailOption.WARN)) {
                logger.info("Executing: " + ranOn + " despite precondition failure due to onFail='WARN':\n " + message);
            } else {
                if (getOnFailMessage() == null) {
                    throw e;
                } else {
            ...
            if (this.getOnError().equals(PreconditionContainer.ErrorOption.CONTINUE)) {
                logger.info("Continuing past: " + toString() + " despite precondition error:\n " + message);
            } else if (this.getOnError().equals(PreconditionContainer.ErrorOption.WARN)) {
                logger.warning("Continuing past: " + toString() + " despite precondition error:\n " + message);
            } else {
