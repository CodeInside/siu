        ...
        while (columnIterator.hasNext()) {
            ...
            if (isAutoIncrementColumn) {
                ...
                if (database.supportsAutoIncrement()) {
                    ...
                    log.warning(database.getTypeName()+" does not support autoincrement columns as request for "+(database.escapeTableName(statement.getSchemaName(), statement.getTableName())));
                }
            }
